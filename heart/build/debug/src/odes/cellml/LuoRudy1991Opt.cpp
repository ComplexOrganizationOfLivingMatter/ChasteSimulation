    ...
    void RegenerateTables()
    {
        ...
        if (mNeedsRegeneration[0])
        {
            ...
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                ...
                _lookup_table_0[i][0] = 0.60470000000000002 * ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) / ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) + (((0.49124000000000001 * exp(0.080320000000000003 * ((var_chaste_interface__membrane__V + 5.476) -  -87.892901713802502))) + (1.0 * exp(0.061749999999999999 * (var_chaste_interface__membrane__V - 506.41709828619742)))) / (1.0 + exp( -0.51429999999999998 * ((var_chaste_interface__membrane__V -  -87.892901713802502) + 4.7530000000000001)))))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][1] = 0.0183 * (1.0 / (1.0 + exp((7.4880000000000004 - var_chaste_interface__membrane__V) * 0.16722408026755853))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][2] = (var_chaste_interface__membrane__V >  -100.0) ? ((2.8370000000000002 * (exp(0.040000000000000001 * (var_chaste_interface__membrane__V + 77.0)) - 1.0)) / ((var_chaste_interface__membrane__V + 77.0) * exp(0.040000000000000001 * (var_chaste_interface__membrane__V + 35.0)))) : 1.0;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][3] = 0.60470000000000002 * ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) / ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) + (((0.49124000000000001 * exp(0.080320000000000003 * ((var_chaste_interface__membrane__V + 5.476) -  -87.892901713802502))) + (1.0 * exp(0.061749999999999999 * (var_chaste_interface__membrane__V - 506.41709828619742)))) / (1.0 + exp( -0.51429999999999998 * ((var_chaste_interface__membrane__V -  -87.892901713802502) + 4.7530000000000001)))))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][4] = 0.0183 * (1.0 / (1.0 + exp((7.4880000000000004 - var_chaste_interface__membrane__V) * 0.16722408026755853))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][5] = 0.60470000000000002 * ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) / ((1.02 / (1.0 + exp(0.23849999999999999 * ((var_chaste_interface__membrane__V -  -87.892901713802502) - 59.215000000000003)))) + (((0.49124000000000001 * exp(0.080320000000000003 * ((var_chaste_interface__membrane__V + 5.476) -  -87.892901713802502))) + (1.0 * exp(0.061749999999999999 * (var_chaste_interface__membrane__V - 506.41709828619742)))) / (1.0 + exp( -0.51429999999999998 * ((var_chaste_interface__membrane__V -  -87.892901713802502) + 4.7530000000000001)))))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][6] = 0.0183 * (1.0 / (1.0 + exp((7.4880000000000004 - var_chaste_interface__membrane__V) * 0.16722408026755853))) * (var_chaste_interface__membrane__V -  -87.892901713802502);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][7] = (0.32000000000000001 * (var_chaste_interface__membrane__V + 47.130000000000003)) / (1.0 - exp( -0.10000000000000001 * (var_chaste_interface__membrane__V + 47.130000000000003)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][8] = 0.080000000000000002 * exp((-var_chaste_interface__membrane__V) * 0.090909090909090912);
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][9] = (var_chaste_interface__membrane__V <  -40.0) ? (0.13500000000000001 * exp((80.0 + var_chaste_interface__membrane__V) *  -0.14705882352941177)) : 0.0;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][10] = (var_chaste_interface__membrane__V <  -40.0) ? ((3.5600000000000001 * exp(0.079000000000000001 * var_chaste_interface__membrane__V)) + (310000.0 * exp(0.34999999999999998 * var_chaste_interface__membrane__V))) : (1.0 / (0.13 * (1.0 + exp((var_chaste_interface__membrane__V + 10.66) *  -0.0900900900900901))));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][11] = (var_chaste_interface__membrane__V <  -40.0) ? (((( -127140.0 * exp(0.24440000000000001 * var_chaste_interface__membrane__V)) - (3.4740000000000003e-05 * exp( -0.043909999999999998 * var_chaste_interface__membrane__V))) * (var_chaste_interface__membrane__V + 37.780000000000001)) / (1.0 + exp(0.311 * (var_chaste_interface__membrane__V + 79.230000000000004)))) : 0.0;
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][12] = (var_chaste_interface__membrane__V <  -40.0) ? ((0.1212 * exp( -0.01052 * var_chaste_interface__membrane__V)) / (1.0 + exp( -0.13780000000000001 * (var_chaste_interface__membrane__V + 40.140000000000001)))) : ((0.29999999999999999 * exp( -2.5349999999999999e-07 * var_chaste_interface__membrane__V)) / (1.0 + exp( -0.10000000000000001 * (var_chaste_interface__membrane__V + 32.0))));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][13] = (0.095000000000000001 * exp( -0.01 * (var_chaste_interface__membrane__V - 5.0))) / (1.0 + exp( -0.071999999999999995 * (var_chaste_interface__membrane__V - 5.0)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][14] = (0.070000000000000007 * exp( -0.017000000000000001 * (var_chaste_interface__membrane__V + 44.0))) / (1.0 + exp(0.050000000000000003 * (var_chaste_interface__membrane__V + 44.0)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][15] = (0.012 * exp( -0.0080000000000000002 * (var_chaste_interface__membrane__V + 28.0))) / (1.0 + exp(0.14999999999999999 * (var_chaste_interface__membrane__V + 28.0)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][16] = (0.0064999999999999997 * exp( -0.02 * (var_chaste_interface__membrane__V + 30.0))) / (1.0 + exp( -0.20000000000000001 * (var_chaste_interface__membrane__V + 30.0)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][17] = (0.00050000000000000001 * exp(0.083000000000000004 * (var_chaste_interface__membrane__V + 50.0))) / (1.0 + exp(0.057000000000000002 * (var_chaste_interface__membrane__V + 50.0)));
            }
            
            for (unsigned i=0 ; i<_table_size_0; i++)
            {
                const double var_chaste_interface__membrane__V = mTableMins[0] + i*mTableSteps[0];
                _lookup_table_0[i][18] = (0.0012999999999999999 * exp( -0.059999999999999998 * (var_chaste_interface__membrane__V + 20.0))) / (1.0 + exp( -0.040000000000000001 * (var_chaste_interface__membrane__V + 20.0)));
            }
...
private:
    ...
    static std::auto_ptr<CellLuoRudy1991FromCellMLOpt_LookupTables> mpInstance;
...
std::auto_ptr<CellLuoRudy1991FromCellMLOpt_LookupTables> CellLuoRudy1991FromCellMLOpt_LookupTables::mpInstance;
...
#undef COVERAGE_IGNORE
        ...
        const double var_time_dependent_potassium_current__i_K = (mParameters[2] * 1.0) * var_chaste_interface__time_dependent_potassium_current_X_gate__X * _lt_0_row[2] * (var_chaste_interface__membrane__V -  -77.567584385319392); // microA_per_cm2
        ...
        const double var_chaste_interface__i_ionic = var_fast_sodium_current__i_Na + var_chaste_interface__slow_inward_current__i_si + var_time_dependent_potassium_current__i_K + _lt_0_row[5] + _lt_0_row[6] + (0.039210000000000002 * (var_chaste_interface__membrane__V -  -59.869999999999997)); // uA_per_cm2
...
#undef COVERAGE_IGNORE
        ...
        const double var_slow_inward_current__i_si = mParameters[0] * var_chaste_interface__slow_inward_current_d_gate__d * var_chaste_interface__slow_inward_current_f_gate__f * (var_chaste_interface__membrane__V - _lt_1_row[0]); // microA_per_cm2
        const double d_dt_chaste_interface__fast_sodium_current_m_gate__m = (_lt_0_row[7] * (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m)) - (_lt_0_row[8] * var_chaste_interface__fast_sodium_current_m_gate__m); // per_millisecond
        const double d_dt_chaste_interface__fast_sodium_current_h_gate__h = (_lt_0_row[9] * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h)) - (_lt_0_row[10] * var_chaste_interface__fast_sodium_current_h_gate__h); // per_millisecond
        const double d_dt_chaste_interface__fast_sodium_current_j_gate__j = (_lt_0_row[11] * (1.0 - var_chaste_interface__fast_sodium_current_j_gate__j)) - (_lt_0_row[12] * var_chaste_interface__fast_sodium_current_j_gate__j); // per_millisecond
        const double d_dt_chaste_interface__slow_inward_current_d_gate__d = (_lt_0_row[13] * (1.0 - var_chaste_interface__slow_inward_current_d_gate__d)) - (_lt_0_row[14] * var_chaste_interface__slow_inward_current_d_gate__d); // per_millisecond
        const double d_dt_chaste_interface__slow_inward_current_f_gate__f = (_lt_0_row[15] * (1.0 - var_chaste_interface__slow_inward_current_f_gate__f)) - (_lt_0_row[16] * var_chaste_interface__slow_inward_current_f_gate__f); // per_millisecond
        const double d_dt_chaste_interface__time_dependent_potassium_current_X_gate__X = (_lt_0_row[17] * (1.0 - var_chaste_interface__time_dependent_potassium_current_X_gate__X)) - (_lt_0_row[18] * var_chaste_interface__time_dependent_potassium_current_X_gate__X); // per_millisecond
        ...
        else
        {
            ...
            const double var_fast_sodium_current__i_Na = mParameters[1] * pow(var_chaste_interface__fast_sodium_current_m_gate__m, 3.0) * var_chaste_interface__fast_sodium_current_h_gate__h * var_chaste_interface__fast_sodium_current_j_gate__j * (var_chaste_interface__membrane__V - 54.794463935091848); // microA_per_cm2
            d_dt_chaste_interface__membrane__V = ( -1.0 / var_membrane__C) * (var_chaste_interface__membrane__I_stim + var_fast_sodium_current__i_Na + var_slow_inward_current__i_si + var_time_dependent_potassium_current__i_K + _lt_0_row[3] + _lt_0_row[4] + (0.039210000000000002 * (var_chaste_interface__membrane__V -  -59.869999999999997))); // 'millivolt per millisecond'
        }
...
#undef COVERAGE_IGNORE
        ...
        const double var_time_dependent_potassium_current__i_K = (mParameters[2] * 1.0) * var_chaste_interface__time_dependent_potassium_current_X_gate__X * _lt_0_row[2] * (var_chaste_interface__membrane__V -  -77.567584385319392); // microA_per_cm2
        const double var_membrane__potassium_currents = var_time_dependent_potassium_current__i_K + _lt_0_row[0] + _lt_0_row[1]; // microA_per_cm2
