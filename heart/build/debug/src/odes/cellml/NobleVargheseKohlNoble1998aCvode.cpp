...
#include "MathsCustomFunctions.hpp"
    ...
    void CellNobleVargheseKohlNoble1998aFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
    ...
    void CellNobleVargheseKohlNoble1998aFromCellMLCvode::EvaluateAnalyticJacobian(long int N, double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -92.849333
        double var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1 = NV_Ith_S(rY, 1);
        ...
        const double var_t12 = exp((0.5 * var_chaste_interface__membrane__V) * 0.037433890822745473); // dimensionless
        ...
        const double var_t17 = (0.018716945411372737 * var_t12) * var_t15; // dimensionless
        const double var_t23 = exp(( -0.5 * var_chaste_interface__membrane__V) * 0.037433890822745473); // dimensionless
        const double var_t24 = 0.0032258064516129032 * var_t23; // dimensionless
        ...
        const double var_t39 = ((4.9999999999999998e-07 * (var_t17 - (( -5.8022530775255481 * var_t24) * var_t26))) * var_t33) * var_t37; // dimensionless
        ...
        const double var_t55 = ((0.00049950000000000005 * (var_t17 - (( -5.8022530775255481 * var_t24) * var_t42))) * var_t49) * var_t53; // dimensionless
        ...
        const double var_t76 = (((0.044642857139999999 * var_t58) / pow(var_t62, 2.0)) * var_t73) * var_t61; // dimensionless
        ...
        const double var_t92 = ((0.00050000000000000001 / pow(var_t80, 2.0)) * (var_chaste_interface__membrane__V - (26.713760659695648 * log(140.0 * var_t84)))) * var_t79; // dimensionless
        ...
        const double var_t107 = 0.0040000000000000001 / var_t80; // dimensionless
        ...
        const double var_t110 = 1.0 / var_t62; // dimensionless
        const double var_t111 = var_t58 * var_t110; // dimensionless
        ...
        const double var_t160 = ((-var_t137) * 9309421124.3716221) * 1.4465406742646261e-08; // dimensionless
        const double var_t165 = 1.040582726326743e-05 / pow(var_t141, 2.0); // dimensionless
        ...
        const double var_t171 = 1.040582726326743e-05 * var_t142; // dimensionless
        ...
        const double var_t204 = ((-var_chaste_interface__L_type_Ca_channel_f_gate__f) * var_chaste_interface__L_type_Ca_channel_f2_gate__f2) * var_t137; // dimensionless
        const double var_t205 = var_t202 * var_t204; // dimensionless
        const double var_t210 = (1.0 / pow(var_t190, 2.0)) * var_t197; // dimensionless
        const double var_t212 = (0.0014012961821292277 * var_t210) * var_t189; // dimensionless
        const double var_t214 = (8.0 * var_t205) * var_t212; // dimensionless
        const double var_t215 = var_t191 * 2.0; // dimensionless
        const double var_t217 = (0.0014012961821292277 * var_t215) * var_t189; // dimensionless
        ...
        const double var_t261 = var_t110 * var_t73; // dimensionless
        ...
        const double var_t386 = (var_t107 * 8314.4719999999998) * var_t383; // dimensionless
        ...
        const double var_t391 = var_t12 * var_t14; // dimensionless
        ...
        const double var_t399 = var_t23 * 2744000.0; // dimensionless
        ...
        const double var_t454 = (((0.00049950000000000005 * var_t23) * 2744000.0) * var_t49) * var_t53; // dimensionless
        ...
        const double var_t482 = (((4.9999999999999998e-07 * var_t23) * 2744000.0) * var_t33) * var_t37; // dimensionless
        ...
        const double var_t495 = 0.1111111111111111 * var_chaste_interface__membrane__V; // dimensionless
        const double var_t497 = exp((-var_t495) + 0.55555555555555558); // dimensionless
        const double var_t498 = 1.0 + var_t497; // dimensionless
        const double var_t500 = 1.0 / pow(var_t498, 2.0); // dimensionless
        const double var_t507 = exp(( -0.066666666666666666 * var_chaste_interface__membrane__V) + 1.3333333333333333); // dimensionless
        const double var_t512 = 50.0 / var_t498; // dimensionless
        const double var_t520 = (0.033333333333333333 * var_chaste_interface__membrane__V) + 1.0; // dimensionless
        const double var_t521 = pow(var_t520, 2.0); // dimensionless
        const double var_t523 = exp((-var_t521) * var_t520); // dimensionless
        const double var_t531 = exp((-var_t495) + 4.4444444444444446); // dimensionless
        const double var_t532 = 1.0 + var_t531; // dimensionless
        const double var_t540 = exp( -0.022222222222222223 * var_chaste_interface__membrane__V); // dimensionless
        const double var_t547 = var_chaste_interface__membrane__V + 41.0; // dimensionless
        const double var_t549 = fabs(var_t547) < 1.0000000000000001e-05; // dimensionless
        const double var_t550 = 0.10000000000000001 * var_chaste_interface__membrane__V; // dimensionless
        ...
        const double var_t567 = exp(( -0.056000000000000001 * var_chaste_interface__membrane__V) - 3.6960000000000002); // dimensionless
        const double var_t576 = 0.125 * var_chaste_interface__membrane__V; // dimensionless
        const double var_t579 = exp(((-var_t576) - 9.375) + 0.0); // dimensionless
        const double var_t585 = exp(((-var_t550) - 7.5) + 0.0); // dimensionless
        const double var_t587 = 1.0 + (320.0 * var_t585); // dimensionless
        const double var_t601 = exp(( -0.25 * var_chaste_interface__membrane__V) - 4.75); // dimensionless
        const double var_t603 = 1.0 - (1.0 * var_t601); // dimensionless
        const double var_t606 = var_chaste_interface__membrane__V + 19.0; // dimensionless
        const double var_t612 = (30.0 / var_t603) - (((7.5 * var_t606) / pow(var_t603, 2.0)) * var_t601); // dimensionless
        const double var_t616 =  -18.9999 < var_chaste_interface__membrane__V; // dimensionless
        const double var_t622 = exp((0.10000000000000001 * var_chaste_interface__membrane__V) + 1.8999999999999999); // dimensionless
        const double var_t623 = var_t622 - 1.0; // dimensionless
        const double var_t631 = (12.0 / var_t623) - (((1.2 * var_t606) / pow(var_t623, 2.0)) * var_t622); // dimensionless
        const double var_t636 = var_chaste_interface__membrane__V + 19.0; // dimensionless
        const double var_t638 = fabs(var_t636) < 0.0001; // dimensionless
        const double var_t639 = 0.25 * var_chaste_interface__membrane__V; // dimensionless
        const double var_t657 = var_chaste_interface__membrane__V + 34.0; // dimensionless
        const double var_t659 = fabs(var_t657) < 0.0001; // dimensionless
        const double var_t660 = var_t639 + 8.5; // dimensionless
        ...
        const double var_t704 = exp( -0.058823529411764705 * var_chaste_interface__membrane__V); // dimensionless
        const double var_t709 = exp((-var_t576) - 1.25); // dimensionless
        const double var_t710 = 1.0 + var_t709; // dimensionless
        const double var_t723 = exp(( -0.20000000000000001 * var_chaste_interface__membrane__V) - 0.80000000000000004); // dimensionless
        ...
        const double var_t908 = (((-var_chaste_interface__L_type_Ca_channel_f2_gate__f2) * var_t137) * 0.00012027221933034354) * var_t198; // dimensionless
        ...
        const double var_t1008 = (-var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds) * var_t137; // dimensionless
        const double var_t1011 = (((0.10000000000000001 * var_t153) * var_t1008) * 1.4465406742646261e-08) * 1.040582726326743e-05; // dimensionless
        const double var_t1013 = 96485.341499999995 * var_t189; // dimensionless
        const double var_t1024 = var_t1008 * 0.00012027221933034354; // dimensionless
        
        // Matrix entries
        DENSE_ELEM(rJacobian, 0, 0) = var_chaste_interface__environment__fake_dt * (mSetVoltageDerivativeToZero ? 0.0 : ((-var_t1) * ((((((((((((((0.00084999999999999995 + var_t39) + var_t55) - var_t76) + var_t92) + var_t105) + var_t107) + var_t109) + var_t111) + var_t116) + var_t120) - var_t129) + var_t151) - var_t169) + (((((((((((((((var_t174 + var_t180) - var_t184) + var_t185) + var_t201) - var_t214) + var_t219) + ((4.0 * var_t221) * var_t199)) - ((8.0 * var_t227) * var_t212)) + ((8.0 * var_t227) * var_t217)) + var_t239) - var_t245) + var_t248) + var_t252) - var_t255) + var_t256))));
        DENSE_ELEM(rJacobian, 1, 0) = var_chaste_interface__environment__fake_dt * ((((5.5555555555555554 * var_t500) * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1)) * var_t497) + ((0.0033333333329999999 * var_t507) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr1_gate__xr1));
        DENSE_ELEM(rJacobian, 2, 0) = var_chaste_interface__environment__fake_dt * ((((5.5555555555555554 * var_t500) * (1.0 - var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2)) * var_t497) + (((0.040000000000000001 * var_t521) * var_t523) * var_chaste_interface__rapid_delayed_rectifier_potassium_current_xr2_gate__xr2));
        DENSE_ELEM(rJacobian, 3, 0) = var_chaste_interface__environment__fake_dt * ((((1.5555555555555556 / pow(var_t532, 2.0)) * (1.0 - var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs)) * var_t531) + ((0.022222222222222223 * var_t540) * var_chaste_interface__slow_delayed_rectifier_potassium_current_xs_gate__xs));
        DENSE_ELEM(rJacobian, 4, 0) = var_chaste_interface__environment__fake_dt * (((var_t549 ? 0.0 : ((200.0 * var_t554) - (((20.0 * var_t547) / pow(var_t553, 2.0)) * var_t552))) * (1.0 - var_chaste_interface__fast_sodium_current_m_gate__m)) + ((448.0 * var_t567) * var_chaste_interface__fast_sodium_current_m_gate__m));
        DENSE_ELEM(rJacobian, 5, 0) = var_chaste_interface__environment__fake_dt * ((( -2.5 * var_t579) * (1.0 - var_chaste_interface__fast_sodium_current_h_gate__h)) - (((64000.0 / pow(var_t587, 2.0)) * var_chaste_interface__fast_sodium_current_h_gate__h) * var_t585));
        DENSE_ELEM(rJacobian, 6, 0) = var_chaste_interface__environment__fake_dt * (3.0 * ((((var_chaste_interface__membrane__V <=  -19.0001) ? var_t612 : (var_chaste_interface__membrane__V <=  -18.9999) ? 0.0 : var_t616 ? var_t612 : NAN) * (1.0 - var_chaste_interface__L_type_Ca_channel_d_gate__d)) - (((var_chaste_interface__membrane__V <=  -19.0001) ? var_t631 : (var_chaste_interface__membrane__V <=  -18.9999) ? 0.0 : var_t616 ? var_t631 : NAN) * var_chaste_interface__L_type_Ca_channel_d_gate__d)));
        DENSE_ELEM(rJacobian, 7, 0) = var_chaste_interface__environment__fake_dt * (0.29999999999999999 * (((var_t659 ? 0.0 : ((6.25 * var_t663) - (((1.5625 * var_t657) / pow(var_t662, 2.0)) * var_t661))) * (1.0 - var_chaste_interface__L_type_Ca_channel_f_gate__f)) - (((3.0 / pow(var_t675, 2.0)) * var_chaste_interface__L_type_Ca_channel_f_gate__f) * var_t674)));
        DENSE_ELEM(rJacobian, 10, 0) = var_chaste_interface__environment__fake_dt * ((( -0.001941176471 * var_t704) * (1.0 - var_chaste_interface__transient_outward_current_s_gate__s)) - (((4.125 / pow(var_t710, 2.0)) * var_chaste_interface__transient_outward_current_s_gate__s) * var_t709));
        DENSE_ELEM(rJacobian, 11, 0) = var_chaste_interface__environment__fake_dt * ((66.599999999999994 / pow(1.0 + var_t723, 2.0)) * var_t723);
        ...
        DENSE_ELEM(rJacobian, 14, 0) = var_chaste_interface__environment__fake_dt * ( -0.63182746008467194 * ((((((((((var_t120 + var_t92) + var_t107) + 0.00059999999999999995) + (3.0 * var_t55)) + var_t151) - var_t169) + var_t174) + var_t180) - var_t184) + var_t185));
        ...
        DENSE_ELEM(rJacobian, 17, 0) = var_chaste_interface__environment__fake_dt * (((((( -0.63661977250000001 * var_t224) * var_t225) * 0.00012027221933034354) * var_t1004) + (((((1.273239545 * var_t1011) * var_t210) * 69444.444444444438) * 27.578599007170439) * var_t1013)) - ((((1.273239545 * var_t1011) * var_t215) * var_t1013) * 1915180.486609058));
        ...
        DENSE_ELEM(rJacobian, 1, 1) = var_chaste_interface__environment__fake_dt * ((-var_t512) - (0.050000000000000003 * var_t507));
        ...
        DENSE_ELEM(rJacobian, 2, 2) = var_chaste_interface__environment__fake_dt * ((-var_t512) - (0.40000000000000002 * var_t523));
        ...
        DENSE_ELEM(rJacobian, 3, 3) = var_chaste_interface__environment__fake_dt * (( -14.0 / var_t532) - var_t540);
        ...
        DENSE_ELEM(rJacobian, 4, 4) = var_chaste_interface__environment__fake_dt * ((-(var_t549 ? 2000.0 : ((200.0 * var_t547) * var_t554))) - (8000.0 * var_t567));
        ...
        DENSE_ELEM(rJacobian, 5, 5) = var_chaste_interface__environment__fake_dt * (( -20.0 * var_t579) - (2000.0 / var_t587));
        ...
        DENSE_ELEM(rJacobian, 6, 6) = var_chaste_interface__environment__fake_dt * (3.0 * ((-(var_t638 ? 120.0 : ((30.0 * var_t636) / (1.0 - exp((-var_t639) - 4.75))))) - (var_t638 ? 120.0 : ((12.0 * var_t636) / (exp((0.10000000000000001 * var_chaste_interface__membrane__V) + 1.8999999999999999) - 1.0)))));
        ...
        DENSE_ELEM(rJacobian, 0, 7) = var_chaste_interface__environment__fake_dt * (mSetVoltageDerivativeToZero ? 0.0 : ((-var_t1) * (((((var_t321 + var_t324) - ((((0.0 * var_chaste_interface__L_type_Ca_channel_d_gate__d) * var_chaste_interface__L_type_Ca_channel_f2_gate__f2) * var_t137) * var_t199)) - ((((0.40000000000000002 * var_chaste_interface__L_type_Ca_channel_d_gate__d) * var_chaste_interface__L_type_Ca_channel_f2ds_gate__f2ds) * var_t137) * var_t199)) + var_t336) + var_t338)));
        DENSE_ELEM(rJacobian, 7, 7) = var_chaste_interface__environment__fake_dt * (0.29999999999999999 * ((-(var_t659 ? 25.0 : ((6.25 * var_t657) * var_t663))) - (12.0 / var_t675)));
        ...
        DENSE_ELEM(rJacobian, 10, 10) = var_chaste_interface__environment__fake_dt * (( -0.033000000000000002 * var_t704) - (33.0 / var_t710));
        ...
        DENSE_ELEM(rJacobian, 13, 13) = var_chaste_interface__environment__fake_dt * (-var_t751);
        ...
        DENSE_ELEM(rJacobian, 0, 16) = var_chaste_interface__environment__fake_dt * (mSetVoltageDerivativeToZero ? 0.0 : ((-var_t1) * ((((((-var_t454) - var_t459) - (144.92753619999999 * var_t464)) + var_t469) + ((4.0 * var_t221) * var_t467)) + var_t476)));
        ...
        DENSE_ELEM(rJacobian, 17, 16) = var_chaste_interface__environment__fake_dt * ((((((0.63661977250000001 * var_t224) * var_t225) * var_t137) * 0.00012027221933034354) * var_t466) * 1915180.486609058);
