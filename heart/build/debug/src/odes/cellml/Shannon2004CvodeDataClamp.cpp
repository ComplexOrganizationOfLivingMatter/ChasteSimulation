...
#include "MathsCustomFunctions.hpp"
                ...
                pIntracellularStimulus)
    {
        ...
        NV_Ith_S(this->mParameters, 8) = 0.0; // (c,chaste_interface__chaste_interface__membrane_data_clamp_current_conductance) [___units_62]
        NV_Ith_S(this->mParameters, 9) = 16; // (c,INa__G_INa) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 10) = 0.03; // (c,IKr__G_IKr_const) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 11) = 0.07; // (c,IKs__G_Ks_Max) [milliS_per_microF]
        NV_Ith_S(this->mParameters, 12) = 9; // (c,INaCa__V_max) [microA_per_microF]
        NV_Ith_S(this->mParameters, 13) = 0.06; // (c,Itos__G_tos) [milliS_per_microF]
    }
    ...
    double CellShannon2004FromCellMLCvodeDataClamp::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_INa__i_Na_jct = 0.11 * NV_Ith_S(mParameters, 9) * var_INa__openProb * (var_chaste_interface__cell__V - var_reversal_potentials__E_Na_jct); // microA_per_microF
        ...
        const double var_INa__i_Na_SL = 0.89000000000000001 * NV_Ith_S(mParameters, 9) * var_INa__openProb * (var_chaste_interface__cell__V - var_reversal_potentials__E_Na_SL); // microA_per_microF
        ...
        const double var_IKr__i_Kr = (NV_Ith_S(mParameters, 10) * sqrt(NV_Ith_S(mParameters, 5) * 0.18518518518518517)) * var_chaste_interface__IKr_Xr_gate__Xr * (1.0 / (1.0 + exp((33.0 + var_chaste_interface__cell__V) * 0.044642857142857144))) * (var_chaste_interface__cell__V - var_reversal_potentials__E_K); // microA_per_microF
        ...
        const double var_IKs__i_Ks = (0.11 * (NV_Ith_S(mParameters, 11) * (0.057000000000000002 + (0.19 / (1.0 + exp(( -7.2000000000000002 + ((-log10(var_chaste_interface__Ca_buffer__Ca_jct * 1.0)) + 3.0)) * 1.6666666666666667))))) * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (var_chaste_interface__cell__V - var_IKs__E_Ks)) + (0.89000000000000001 * (NV_Ith_S(mParameters, 11) * (0.057000000000000002 + (0.19 / (1.0 + exp(( -7.2000000000000002 + ((-log10(var_chaste_interface__Ca_buffer__Ca_SL * 1.0)) + 3.0)) * 1.6666666666666667))))) * pow(var_chaste_interface__IKs_Xs_gate__Xs, 2.0) * (var_chaste_interface__cell__V - var_IKs__E_Ks)); // microA_per_microF
        ...
        const double var_Itos__i_tos = NV_Ith_S(mParameters, 13) * var_chaste_interface__Itos_X_gate__X_tos * (var_chaste_interface__Itos_Y_gate__Y_tos + (0.5 * var_chaste_interface__Itos_R_gate__R_tos)) * (var_chaste_interface__cell__V - var_reversal_potentials__E_K); // microA_per_microF
    ...
    void CellShannon2004FromCellMLCvodeDataClamp::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_INa__G_INa = mp_membrane_fast_sodium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 9), var_chaste_interface__environment__time); // milliS_per_microF
        const double var_INa__openProb = pow(var_chaste_interface__INa_m_gate__m, 3.0) * var_chaste_interface__INa_h_gate__h * var_chaste_interface__INa_j_gate__j; // dimensionless
        ...
        const double var_INaCa__V_max = mp_membrane_sodium_calcium_exchanger_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 12), var_chaste_interface__environment__time); // microA_per_microF
        ...
        else
        {
            ...
            const double var_INab__i_Nab = var_INab__i_Nab_jct + var_INab__i_Nab_SL; // microA_per_microF
            const double var_INaK__i_NaK = var_INaK__i_NaK_jct + var_INaK__i_NaK_SL; // microA_per_microF
            const double var_IKr__G_IKr_const = mp_membrane_rapid_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 10), var_chaste_interface__environment__time); // milliS_per_microF
            ...
            const double var_IKs__G_Ks_Max = mp_membrane_slow_delayed_rectifier_potassium_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 11), var_chaste_interface__environment__time); // milliS_per_microF
            ...
            const double var_IKp__i_Kp = (0.001 * (var_chaste_interface__cell__V - var_reversal_potentials__E_K)) / (1.0 + exp(7.4880000000000004 - (var_chaste_interface__cell__V * 0.16722408026755853))); // microA_per_microF
            const double var_Itos__G_tos = mp_membrane_transient_outward_current_conductance_modifier->Calc(NV_Ith_S(mParameters, 13), var_chaste_interface__environment__time); // milliS_per_microF
            ...
            if (mDataClampIsOn)
            {
                var_chaste_interface__membrane_data_clamp_current = NV_Ith_S(mParameters, 8) * (var_chaste_interface__cell__V - GetExperimentalVoltageAtTimeT(var_chaste_interface__environment__time)); // uA_per_cm2
            }
            d_dt_chaste_interface__cell__V = -(var_INa__i_Na + var_chaste_interface__membrane_data_clamp_current + var_INab__i_Nab + var_INaK__i_NaK + var_IKr__i_Kr + var_IKs__i_Ks + var_Itos__i_tos + var_Itof__i_tof + var_IK1__i_K1 + var_INaCa__i_NaCa + var_ICl_Ca__i_Cl_Ca + var_IClb__i_Clb + var_ICaL__i_CaL + var_ICab__i_Cab + var_ICap__i_Cap + var_IKp__i_Kp + (var_chaste_interface__cell__i_Stim / HeartConfig::Instance()->GetCapacitance())); // 'millivolt per millisecond'
        }
    ...
    N_Vector CellShannon2004FromCellMLCvodeDataClamp::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const N_Vector & rY)
    {
        ...
        NV_Ith_S(dqs, 5) = var_chaste_interface__INa__i_Na;
        NV_Ith_S(dqs, 6) = var_chaste_interface__IK1__i_K1;
        NV_Ith_S(dqs, 7) = var_chaste_interface__IKr__i_Kr;
        NV_Ith_S(dqs, 8) = var_chaste_interface__IKs__i_Ks;
        NV_Ith_S(dqs, 9) = var_chaste_interface__INaCa__i_NaCa;
        NV_Ith_S(dqs, 10) = var_chaste_interface__cell__i_Stim;
        NV_Ith_S(dqs, 11) = var_chaste_interface__Itos__i_tos;
...
void OdeSystemInformation<CellShannon2004FromCellMLCvodeDataClamp>::Initialise(void)
{
    ...
    this->mParameterUnits.push_back("___units_62");
