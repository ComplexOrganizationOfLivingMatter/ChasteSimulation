...
namespace chaste
{
  namespace parameters
  {
    ...
    class location_type: public ::xml_schema::type
    {
      ...
      location_type (::std::auto_ptr< Cuboid_type >&);
    ...
    class postprocessing_type: public ::xml_schema::type
    {
      ...
      void
      MaxUpstrokeVelocityMap (::std::auto_ptr< MaxUpstrokeVelocityMap_type > p);
    ...
    class chaste_parameters_type: public ::xml_schema::type
    {
      ...
      chaste_parameters_type (::std::auto_ptr< Simulation_type >&,
                              ::std::auto_ptr< Physiological_type >&,
